        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center">
              <motion.span {...childProps} className="inline-block text-primary text-xs font-bold uppercase mb-4" style={{ letterSpacing: "0.14em" }}>
                Let&apos;s Build Something
              </motion.span>
              <motion.h2 {...childProps} className="font-display font-extrabold leading-[1.05] mb-4 text-text-primary" style={{ fontSize: "clamp(32px, 5vw, 44px)" }}>

...
export const metadata: Metadata = {
  ...
  description:
    "How Xpersive Labs built a fully automated Alibaba supplier intelligence platform for an Australian importer, replacing 8 to 10 hours of manual weekly research with a 5-function automation module extracting 47 unique data fields daily.",
  alternates: {
